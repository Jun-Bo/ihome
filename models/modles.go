...
func init() {
	...
	//连接数据库
	//	orm.RegisterDataBase("default", "mysql", "root:123456@/ihome?charset=utf8")
	orm.RegisterDataBase("default", "mysql", "root:123456@tcp(192.168.22.53:3306)/ihome?charset=utf8")

	//注册数据库
	orm.RegisterModel(new(Area), new(Facility), new(House), new(HouseImage), new(OrderHouse), new(User))
